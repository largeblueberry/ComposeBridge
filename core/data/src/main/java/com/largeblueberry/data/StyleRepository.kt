...
class StyleRepository {
    private val database = mapOf(
        ...
        "20대 여성" to UiStyleConfig(
            ...
            buttonShape = androidx.compose.foundation.shape.RoundedCornerShape(16.dp)
        ),
        "30대 직장인" to UiStyleConfig(
            ...
            buttonShape = androidx.compose.foundation.shape.RoundedCornerShape(4.dp)
        ),
        "실버 세대" to UiStyleConfig(
            ...
            buttonShape = androidx.compose.foundation.shape.RoundedCornerShape(8.dp)
        )
    )
